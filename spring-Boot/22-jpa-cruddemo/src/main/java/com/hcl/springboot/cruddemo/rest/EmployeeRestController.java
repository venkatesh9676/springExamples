package com.hcl.springboot.cruddemo.rest;
...
import com.hcl.springboot.cruddemo.service.EmployeeService;
...
public class EmployeeRestController {
	...
	public Employee addEmployee(@RequestBody Employee theEmployee) {
		...
		// also just in case they pass an id in JSON...as id to 0
